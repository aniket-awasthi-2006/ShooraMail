  ...
  return (
    <div className="relative flex flex-col items-center justify-center text-center px-4 md:px-6 overflow-visible max-w-5xl mx-auto py-12 md:py-24">
      ...
      <div className="absolute inset-0 pointer-events-none select-none hidden lg:block">
        <FloatingIcon icon={Mail} delay={0} className="top-[-60px] md:top-[-40px] left-[0%] lg:left-[-5%]" themeMode={themeMode} />
        <FloatingIcon icon={Inbox} delay={1.2} className="top-[140px] md:top-[160px] left-[-20px] lg:left-[10%]" themeMode={themeMode} />
        <FloatingIcon icon={FileText} delay={0.6} className="bottom-[-20px] left-[5%] lg:left-[-8%]" themeMode={themeMode} />
        <FloatingIcon icon={Calendar} delay={0.3} className="top-[-50px] md:top-[-30px] right-[0%] lg:right-[-5%]" themeMode={themeMode} />
        <FloatingIcon icon={Paperclip} delay={1.5} className="top-[200px] md:top-[220px] right-[-10px] lg:right-[12%]" themeMode={themeMode} />
        <FloatingIcon icon={Search} delay={0.9} className="bottom-[-30px] right-[5%] lg:right-[-5%]" themeMode={themeMode} />
      </div>
