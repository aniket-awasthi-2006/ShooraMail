            ...
            >
              ...
              {(!isCollapsed || isMobile) && (
                <div className="flex-1 overflow-hidden transition-all duration-700">
                  <span className="text-[12px] font-black block truncate transition-colors duration-700" style={{ color: colors.textMain }}>7ahang</span>
                  <span className="text-[10px] font-bold opacity-60 truncate block transition-colors duration-700" style={{ color: colors.textMuted }}>7ahang@gmail.com</span>
                </div>
              )}
              {(!isCollapsed || isMobile) && (
